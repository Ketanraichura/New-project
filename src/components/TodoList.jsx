  ...
  return (
    <section className="rounded-lg bg-white p-6 shadow-sm ring-1 ring-slate-200">
      ...
      <form className="mt-6 flex flex-col gap-3 sm:flex-row" onSubmit={addTodo}>
        <input
          className="min-w-0 flex-1 rounded-md border border-slate-300 px-4 py-2 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
          ...
          >
            {editingId === todo.id ? (
              <div className="flex flex-col gap-3 sm:flex-row">
                <input
                  className="min-w-0 flex-1 rounded-md border border-slate-300 px-3 py-2 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
